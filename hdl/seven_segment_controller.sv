...
module seven_segment_controller #(parameter COUNT_PERIOD = 100000)
    ...
    always_comb begin
        if (segment_state == 8'h01) begin sel_values = val[3:0];
        end else if (segment_state == 8'h02) begin sel_values = val[7:4];
        end else if (segment_state == 8'h04) begin sel_values = val[11:8];
        end else if (segment_state == 8'h08) begin sel_values = val[15:12];
        end else if (segment_state == 8'h10) begin sel_values = val[19:16];
        end else if (segment_state == 8'h20) begin sel_values = val[23:20];
        end else if (segment_state == 8'h40) begin sel_values = val[27:24];
        end else if (segment_state == 8'h80) begin sel_values = val[31:28];
        end else begin sel_values = 0;
        end
    end
